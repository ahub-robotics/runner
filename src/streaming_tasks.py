...
@celery_app.task(bind=True, name='src.streaming_tasks.start_streaming_task')
...
@celery_app.task(name='src.streaming_tasks.stop_streaming_task')
...
@celery_app.task(name='src.streaming_tasks.get_streaming_status')
